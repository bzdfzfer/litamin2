...
int main(int argc, char** argv) {
  ...
  litamin2_ceres.setLocalParameterization(true);
  litamin2_ceres.setDebugPrint(false);
  litamin2_ceres.setLSQType(fast_gicp::LSQ_OPTIMIZER_TYPE::CeresDogleg);
  test(litamin2_ceres, target_cloud, source_cloud);
  ...
  pcl::PointCloud<pcl::PointXYZ>::Ptr aligned2(new pcl::PointCloud<pcl::PointXYZ>);
  litamin2_ceres.align(*aligned2);
  vis.addPointCloud<pcl::PointXYZ>(aligned2, 
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ>(aligned2, 255.0, 0.0, 0.0), 
    "aligned2");
